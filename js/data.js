...
export const portfolioData = {
  ...
  projects: [
    {
      status: "Flagship",
      tags: ["Python", "RAG", "AI Agent", "Ollama"],
      color: "rgba(34, 211, 238, 0.15)",
      image: "images/codebase-agent-hero.svg",
      title: "Codebase Q&A Agent",
      desc: "A local, zero-cost AI agent that answers questions about a codebase using RAG, tool-calling, and conversational memory — no API keys, no cloud costs.",
      url: "projects/codebase-agent.html"
    }
  ]
};
